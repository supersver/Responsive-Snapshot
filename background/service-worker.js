...
async function captureFullPage(url, width) {
  ...
  try {
    ...
    // Stitch
    const stitched = await stitchImages(partImages, viewportWidth, scrollHeight, viewportHeight, dpr);
    return stitched;
...
/* ═══════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════ */
async function stitchImages(parts, pageWidth, totalHeight, viewportHeight, dpr) {
...
function notifyProgress(current, total, label) {
  ...
  chrome.runtime.sendMessage({ action: 'progress', current, total, percent, label })
